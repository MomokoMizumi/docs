...
description: "Bash Cheatsheet for scripting"
sidebarTitle: "Bash Cheatsheet"
---
...
<Frame>
  ...
  | `{{1..3},{7..9}}` | Same as `1 2 3 7 8 9`ge of your Frame component here. |
</Frame>
...
```bash
echo "Welcome To heLL" | tr '[:lower:]' '[:upper:]'
WELCOME TO HELL
```
